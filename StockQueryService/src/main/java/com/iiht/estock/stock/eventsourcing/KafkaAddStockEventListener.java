...
public class KafkaAddStockEventListener {

    private final StockQueryService stockQueryService;
    private final CountDownLatch latch = new CountDownLatch(3);

    @KafkaListener(topics = "${message.topic.addStock}")
    public void listen(ConsumerRecord<String, String> stringConsumerRecord) throws JsonProcessingException {
        ...
        stockQueryService.createStock(stock);
        log.info("Created stock {} in reader database", stock);
        latch.countDown();
    }
}
